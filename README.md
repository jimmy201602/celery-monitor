...
CELERY_BIN="/home/op1/celeryenv/bin/celery"
# App instance to use
...
CELERYD_CHDIR="/home/op1/celeryenv/dbajobs/proj"
# Extra command-line arguments to the worker
CELERYD_OPTS="--time-limit=300 --concurrency=8 --autoscale=8,24 --autoreload --Q high"
...
```
# 4 配置celery 心跳服务
**保存配置文件至/etc/default/celerybeat**
...
# Where to chdir at start.
CELERYBEAT_CHDIR="/home/op1/celeryenv/dbajobs/proj"
...
```
---------
# 5 配置celery worker和心跳服务
> * clery worker service
**保存配置文件至/etc/init.d/celeryd**
...
```sh
celery -A celeryproj flower --port=5000 --address=0.0.0.0
```
